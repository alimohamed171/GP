...
// why do you need to put it in the DTO !! 
    ...
    public ResponseEntity<Object> getApplicationStatusByNID(String nationalId) {
        ...
        if (!loggedInUser.getNationalId().equals(nationalId)) {
            BaseResponse response = new BaseResponse(false, "You are not authorized to access this application status", null);
